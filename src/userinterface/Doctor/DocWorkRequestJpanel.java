...
public class DocWorkRequestJpanel extends javax.swing.JPanel {
    ...
    public DocWorkRequestJpanel(JPanel userProcessContainer, UserAcc account,
            DoctorOrg organization, Enterprise enterprise, EcoSystem system, Connection network) {
        initComponents();
        initComponents();
    ...
    public void populateRequestTable() {
        ...
        for (WorkRequest request : account.getWorkQueue().getWorkRequestList()) {
            if (request instanceof LabTestWorkRequest) {
                ...
                String result = ((LabTestWorkRequest) request).getPatient().getVariantHistory()
    ...
    private void initComponents() {
        ...
        requestTestBtn.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        doctorRequestTbl.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

        }, new String[] {"Patient Name", "Age", "Sex", "Message", "Receiver", "Status",
                "Variant"}) {
        ...
        viewResultsbtn.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        sexcomboBox.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] {"SELECT", "MALE", "FEMALE"}));
        ...
        jLabel1.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/Image/new-normality.png"))); // NOI18N
        ...
        btnClinicalTrial.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        doctorClinicRequestTbl.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

        }, new String[] {"Patient Name", "Age", "Sex", "Message", "Receiver", "Status", "Sample"}) {
            Class[] types = new Class[] {java.lang.String.class, java.lang.Integer.class,
                    java.lang.String.class, java.lang.String.class, java.lang.String.class,
                    java.lang.String.class, java.lang.String.class};
            boolean[] canEdit = new boolean[] {false, false, false, false, false, false, false};
        ...
        jLabel2.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/Image/safety-suit.png"))); // NOI18N
    ...
    private void viewResultsbtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_viewResultsbtnActionPerformed
        ...
        LabTestWorkRequest request =
                (LabTestWorkRequest) doctorRequestTbl.getValueAt(selectedRow, 0);
        System.out.println(doctorRequestTbl.getValueAt(selectedRow, 5));
        System.out.println(!(doctorRequestTbl.getValueAt(selectedRow, 5).toString().toLowerCase()
        ...
        int flag = 0;
        if ((doctorRequestTbl.getValueAt(selectedRow, 5).toString()
                .equalsIgnoreCase("completed"))) {
        ...
        DoctorLabTestResultsJpanel processWorkRequestJPanel =
                new DoctorLabTestResultsJpanel(userProcessContainer, request);
        ...
        try {
            ...
            for (WorkRequest request : account.getWorkQueue().getWorkRequestList()) {
                if (request instanceof ClinicalTrialWorkRequest) {
                    ...
                    row[4] = request.getReceiver();
                    row[5] = request.getStatus();
                    String result = ((ClinicalTrialWorkRequest) request).getPatient()
                            .getVariantHistory().getVariantHistory().getVariantName();
                    if (request.getReceiver() == null
                            || request.getReceiver().equals("Processing")) {
                        row[6] = null;
                    } else {
                        row[6] = result;
                    }
