...
public class PharmacyMainJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        docrequestTable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

        }, new String[] {"MEDICINE NAME", "QUANTITY", "STATUS"}) {
        ...
        reorderTable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

        }, new String[] {"MEDICINE NAME", "SERIAL NUMBER ", "AVAILABILE QUANTITY",
                "REQUIRED QUANTITY", "REORDER STATUS"}) {
        ...
        serialNumLbl.setForeground(new java.awt.Color(51, 0, 51));
        serialNumLbl.setText("SERIAL NUMBER: ");
        add(serialNumLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, -1, -1));
        add(serialNumberTxtField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 320, 141, -1));

        medicineNameLbl.setForeground(new java.awt.Color(51, 0, 51));
        medicineNameLbl.setText("MEDICINE NAME: ");
        add(medicineNameLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, -1, -1));
        add(medicineNameTxtField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 350, 141, -1));

        availQuantityLbl.setForeground(new java.awt.Color(51, 0, 51));
        ...
        add(availQuantityTxtField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 380, 141, -1));

        reqQuantityLbl.setForeground(new java.awt.Color(51, 0, 51));
        ...
        add(reqQuantityTxtField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 420, 141, -1));

        viewRequestsBtn.setBackground(new java.awt.Color(51, 0, 51));
        viewRequestsBtn.setForeground(new java.awt.Color(255, 255, 255));
        viewRequestsBtn.setText("REQUEST STATUS");
        viewRequestsBtn.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
        ...
        addMedicineBtn.setBackground(new java.awt.Color(51, 0, 51));
        addMedicineBtn.setForeground(new java.awt.Color(255, 255, 255));
        addMedicineBtn.setText("ADD MEDICINE");
        addMedicineBtn.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        viewDetailsBtn.setBackground(new java.awt.Color(51, 0, 51));
        viewDetailsBtn.setForeground(new java.awt.Color(255, 255, 255));
        viewDetailsBtn.setText("UPDATE MEDICINE INFO");
        viewDetailsBtn.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        statusCheckBtn.setBackground(new java.awt.Color(51, 0, 51));
        statusCheckBtn.setForeground(new java.awt.Color(255, 255, 255));
        statusCheckBtn.setText("RE-ORDER MEDICINE");
        statusCheckBtn.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        pharmacyLbl.setForeground(new java.awt.Color(51, 0, 51));
        ...
        btnDeliver.setBackground(new java.awt.Color(51, 0, 51));
        btnDeliver.setForeground(new java.awt.Color(255, 255, 255));
        btnDeliver.setText("SUPPLIED TO HOSPITAL");
        btnDeliver.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        btnPending.setBackground(new java.awt.Color(51, 0, 51));
        btnPending.setForeground(new java.awt.Color(255, 255, 255));
        btnPending.setText("ASSIGN");
        btnPending.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
    ...
    private void addMedicineBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_addMedicineBtnActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Medicine Added Successfully", "Warning",
    ...
    private void viewDetailsBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_viewDetailsBtnActionPerformed
        ...
        if (row < 0) {
            JOptionPane.showMessageDialog(null, "Pls select a row!!", "Warning",
    ...
    private void statusCheckBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_statusCheckBtnActionPerformed
                        ...
                        for (Organization organization : enterprise.getOrganizationDirectory()
                            ...
                            if (organization.getName().equals("Medicine Organization")) {
                                ...
                                log.debug(userAccount + " "
                                        + "sending request to Medicine Organization");
                            }
                        }
        ...
        JOptionPane.showMessageDialog(this, "Inventory status checked and updated!", "Warning",
                JOptionPane.INFORMATION_MESSAGE);
        reorderTable();
    ...
    private void btnDeliverActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeliverActionPerformed
        ...
        try {
            ...
            for (MedicalInventory mi : pharmorg.getMedList()) {
                if (mi.getMedName() == String
                        .valueOf(reorderTable.getValueAt(selectedReorderTblRow, 0))) {
                    for (WorkRequest request : pharmorg.getWq().getWorkRequestList()) {
                        if ((request instanceof PharmacyWorkRequest)
                                && ((((PharmacyWorkRequest) request).getMedName()) == (String
                                        .valueOf(docrequestTable.getValueAt(selectedDocReqTblRow,
                                                0))))
                                && (mi.getMedName()
                                        .equals(((PharmacyWorkRequest) request).getMedName()))) {
                            if (((PharmacyWorkRequest) request).getStatus().equals("Pending")) {
                                if ((mi.getQtyAvail() >= ((PharmacyWorkRequest) request)
                                        .getQty())) {

                                    int availableQuantity = mi.getQtyAvail();
                                    int requestedQuantity = Integer.parseInt(String
                                            .valueOf(((PharmacyWorkRequest) request).getQty()));
                                    availableQuantity = availableQuantity - requestedQuantity;
                                    mi.setQtyAvail(availableQuantity);
                                    if (mi.getQtyAvail() <= 10) {
                                        JOptionPane.showMessageDialog(null, "The medicine"
                                                + mi.getMedName() + "is very low. Kindly re-stock");
                                    }
                                    ((PharmacyWorkRequest) request).setStatus("Delivered");
                                } else {
                                    JOptionPane.showMessageDialog(null,
                                            "The availability quantity is less than required quantity");
                                }
                            } else {
                                JOptionPane.showMessageDialog(null, "The current staus is "
                                        + ((PharmacyWorkRequest) request).getStatus());
                            }
                        } else {
    ...
    private void btnPendingActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnPendingActionPerformed
        ...
        if (selectedRow >= 0) {
            for (WorkRequest request : pharmorg.getWq().getWorkRequestList()) {
                if ((request instanceof PharmacyWorkRequest) && (((PharmacyWorkRequest) request)
                        .getMedName() == docrequestTable.getValueAt(selectedRow, 0))) {
                    if (((PharmacyWorkRequest) request).getStatus().equals("Sent")) {
                        ((PharmacyWorkRequest) request).setStatus("Pending");
                    } else {
                        JOptionPane.showMessageDialog(this,
                                "Request is at " + ((PharmacyWorkRequest) request).getStatus());
                    }
                }
            }
        } else {
