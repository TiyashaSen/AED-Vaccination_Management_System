 ...
 */
package userinterface.ClinicTestCenter;
 ...
 */
public class AssistantWorkJPanel extends javax.swing.JPanel {
    ...
    private static Logger log = Logger.getLogger(AssistantWorkJPanel.class);
    private static final String CLASS_NAME = AssistantWorkJPanel.class.getName();

    /**
     * Creates new form LabAssistantWorkAreaJPanel
     */
    public AssistantWorkJPanel(JPanel userProcessContainer, UserAcc userAccount,
        ...
        try {
            ...
            for (WorkRequest request : clinicOrganization.getWq().getWorkRequestList()) {
                ...
                if (request instanceof ClinicalTrialWorkRequest) {
                    ...
                    row[5] = request.getReceiver() == null ? null
                    ...
                    if (request.getReceiver() == null
                        ...
                        row[7] = ((ClinicalTrialWorkRequest) request).getPatient()
    ...
    private void initComponents() {
        ...
        }, new String[] {"PATIENT NAME", "AGE", "SEX", "MESSAGE", "SENDER", "RECEIVER", "STATUS",
                "SAMPLE DETECTED"}) {
        ...
        refreshJButton.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
    ...
    private void assignBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_assignBtnActionPerformed
        ...
        if (workRequestJTable.getValueAt(selectedRow, 6) != null) {
            if (workRequestJTable.getValueAt(selectedRow, 5) != null) {
                if (userAccount.getUsername().equalsIgnoreCase(
                        workRequestJTable.getValueAt(selectedRow, 5).toString())) {
        ...
        if (workRequestJTable.getValueAt(selectedRow, 5) != null) {
            if (!userAccount.getUsername()
                    .equalsIgnoreCase(workRequestJTable.getValueAt(selectedRow, 5).toString())) {
                JOptionPane.showMessageDialog(null, "Task is already assigned");
                return;
            }
        }
        ...
        for (WorkRequest request : clinicOrganization.getWq().getWorkRequestList()) {
            ...
            if (workRequestJTable.getValueAt(selectedRow, 5) != null) {
                if (request.getStatus().equals("Processing")
                        && userAccount.getUsername().equalsIgnoreCase(
                                workRequestJTable.getValueAt(selectedRow, 5).toString())) {
                    flag1 = 1;
                }
            }
    ...
    private void processBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_processBtnActionPerformed
        ...
        ClinicalTrialWorkRequest request =
                (ClinicalTrialWorkRequest) workRequestJTable.getValueAt(selectedRow, 0);
        if (workRequestJTable.getValueAt(selectedRow, 6) != null) {
            if (((workRequestJTable.getValueAt(selectedRow, 6).equals("Completed")))) {
        ...
        if (workRequestJTable.getValueAt(selectedRow, 5) != null) {
            if (workRequestJTable.getValueAt(selectedRow, 6) == null || !userAccount.getUsername()
                    .equalsIgnoreCase(workRequestJTable.getValueAt(selectedRow, 5).toString())) {
        ...
        ProcessWorkJPanel processWorkRequestJPanel = new ProcessWorkJPanel(userProcessContainer,
                request, clinicOrganization, userAccount, network);
