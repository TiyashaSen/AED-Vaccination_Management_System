...
public class ProcessWorkJPanel extends javax.swing.JPanel {
     ...
     */
    public ProcessWorkJPanel(JPanel userProcessContainer, ClinicalTrialWorkRequest request,
    ...
    private void initComponents() {
        ...
        addSampleBtn.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        jLabel1.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/Image/chemical-reaction.png"))); // NOI18N
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_backBtnActionPerformed
        ...
        AssistantWorkJPanel dwjp = (AssistantWorkJPanel) component;
        dwjp.populateTable();
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_submitBtnActionPerformed
        ...
        String sampleCheck;
        Variant v = ((ClinicalTrialWorkRequest) request).getPatient().getVariantHistory()
                .getVariantHistory();
        ...
        for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
            ...
            for (Organization organization : enterprise.getOrganizationDirectory()
                ...
                if (organization.getName().equals("Medicine Organization")
                        || organization.getName().equals("Lab Organization")
                                | organization.getName().equals("Clinic Organization")) {
