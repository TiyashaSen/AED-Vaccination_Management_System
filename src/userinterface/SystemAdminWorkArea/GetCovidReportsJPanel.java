 ...
 */
public class GetCovidReportsJPanel extends javax.swing.JPanel {
    ...
    private static Logger log = Logger.getLogger(GetCovidReportsJPanel.class);
    private static final String CLASS_NAME = GetCovidReportsJPanel.class.getName();

    public GetCovidReportsJPanel(JPanel userProcessContainer, EcoSystem system) {
        initComponents();
