...
public class AddVaccineRequestsJPanel extends javax.swing.JPanel {
     ...
     */
    public AddVaccineRequestsJPanel(JPanel userProcessContainer, UserAcc userAccount,
            Enterprise enterprise, Medicine drugOrganization, Connection network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        }, new String[] {"VACCINE NAME", "SERIAL NUMBER ", "AVAILABILE QUANTITY",
        ...
        add(addMedicineButton,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(221, 522, 106, 33));
        ...
        add(viewRequestsButton,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(771, 197, -1, 35));
        ...
        add(viewDetailsButton1,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(771, 250, 170, 35));
        ...
        add(statusCheckButton,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(771, 143, 170, 36));
        ...
        add(serialNumberTextField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(221, 370, 106, -1));
        ...
        add(chemicalNameTextField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(221, 408, 106, -1));
        ...
        add(availQuantityTextField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(221, 440, 106, -1));
        ...
        add(reqQuantityTextField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(221, 478, 106, -1));
    ...
    private void addMedicineButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_addMedicineButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "vaccine Added Successfully", "Warning",
    ...
    private void viewRequestsButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_viewRequestsButtonActionPerformed
        ...
        userProcessContainer.add("ViewRequestJPanel", new GetVaccineRequestsJPanel(
    ...
    private void viewDetailsButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_viewDetailsButton1ActionPerformed
        ...
        userProcessContainer.add("UpdateEntryJPanel",
                new GetVaccineDetailsJPanel(userProcessContainer, userAccount, enterprise, mi));
        layout.next(userProcessContainer);
