 ...
 * @author tiyashasen
 */
public class LabTechnicianMainJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form LabTechnicianMainJPanel
     */
    public LabTechnicianMainJPanel(JPanel userProcessContainer, UserAcc userAccount,
            ...
            for (WorkRequest request : labOrganization.getWq().getWorkRequestList()) {
                if (request instanceof LabTestWorkRequest) {
                    ...
                    if (request.getReceiver() == null
                        ...
                        row[7] = ((LabTestWorkRequest) request).getPatient().getVariantHistory()
    ...
    private void processBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_processBtnActionPerformed
        ...
        LabTestWorkRequest request =
                (LabTestWorkRequest) workRequestJTable.getValueAt(selectedRow, 0);
        if (workRequestJTable.getValueAt(selectedRow, 6) != null) {
            if (((workRequestJTable.getValueAt(selectedRow, 6).equals("Completed")))) {
        ...
        LabWorkRequestJPanel processWorkRequestJPanel = new LabWorkRequestJPanel(
                userProcessContainer, request, labOrganization, userAccount, network);
