...
public class GetSampleRequestsJPanel extends javax.swing.JPanel {
     ...
     */
    public GetSampleRequestsJPanel(JPanel userProcessContainer, UserAcc userAccount,
            Enterprise enterprise, Organization drugOrganization, Connection network,
            EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        }, new String[] {"SAMPLE NAME", "SERIAL NUMBER ", "AVAILABILE QUANTITY",
        ...
        addMedicineButton.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
        ...
        viewRequestsButton.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        add(viewRequestsButton,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 290, 170, 39));
        ...
        viewDetailsButton1.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        add(viewDetailsButton1,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 360, 170, 39));
        ...
        statusCheckButton.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1,
                new java.awt.Color(255, 255, 255)));
        ...
        add(statusCheckButton,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 230, 170, 34));
        ...
        add(serialNumberTextField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 490, 100, 30));
        ...
        add(chemicalNameTextField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 530, 100, 30));
        ...
        add(availQuantityLabel,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 500, -1, -1));
        add(availQuantityTextField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 490, 96, 30));
        ...
        add(reqQuantityTextField,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 530, 96, 30));
        ...
        jLabel2.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/Image/chemistry-2.png"))); // NOI18N
    ...
    private void addMedicineButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_addMedicineButtonActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Sample Added Successfully", "Warning",
            ...
            JOptionPane.showMessageDialog(null, "Check the data. Value cannot be added", "Warning",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void viewRequestsButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_viewRequestsButtonActionPerformed
        ...
        userProcessContainer.add("ViewRequestsSampleJPanel", new GetRequestsSampleJPanel(
                userProcessContainer, userAccount, enterprise, drugOrganization));
    ...
    private void viewDetailsButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_viewDetailsButton1ActionPerformed
        ...
        userProcessContainer.add("UpdateEntryJPanel",
                new GetSampleDetailsJPanel(userProcessContainer, userAccount, enterprise, mi));
        layout.next(userProcessContainer);
    ...
    private void statusCheckButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_statusCheckButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Inventory status checked and updated!", "Warning",
                JOptionPane.INFORMATION_MESSAGE);
        reorderTable();
